...
export class ApiService {
  ...
  nodeApiUrl="http://localhost:3402/api/Produts/";
...
UpdateProducts(data :any,id:number){
  ...
  return this.http.post<any>(this.nodeApiUrl+'update',data,header);
  }
  ...
  body: { _id: Id} 
    ...
    return this.http.post<any>(this.nodeApiUrl+'update',options);
  }*/
...
body: { _id: Id} 
  ...
  return this.http.post<any>(this.nodeApi2Url+'update',data,options);
}
/*UpdateVendor(data :any,id:number){
  return this.http.put<any>("http://localhost:3402/api/Vendor/update"+id,data)
